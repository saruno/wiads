 ...
 * @method     ChildLocationQuery orderByCode($order = Criteria::ASC) Order by the code column
 ...
 * @method     ChildLocationQuery groupByCode() Group by the code column
 ...
 * @method     ChildLocation findOneByCode(string $code) Return the first ChildLocation filtered by the code column
 ...
 * @method     ChildLocation requireOneByCode(string $code) Return the first ChildLocation filtered by the code column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildLocation[]|ObjectCollection findByCode(string $code) Return ChildLocation objects filtered by the code column
...
abstract class LocationQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Common\DbBundle\Model\Base\LocationQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Common\\DbBundle\\Model\\Location', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name`, `code`, `created_at`, `updated_at` FROM `location` WHERE `id` = :p0';
        try {
    ...
    public function filterByCode($code = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(LocationTableMap::COL_CODE, $code, $comparison);
    }
