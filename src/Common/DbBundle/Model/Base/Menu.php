...
abstract class Menu implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Common\\DbBundle\\Model\\Map\\MenuTableMap';
     ...
     * @var ObjectCollection|ChildMenuI18n[]
     */
    ...
    /**
     * Initializes internal state of Common\DbBundle\Model\Base\Menu object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Common\DbBundle\Model\Menu The current object (for fluent API support)
     */
    ...
    public function setDeep($v)
    {
        ...
        if ($this->deep !== $v) {
            $this->deep = $v;
            $this->modifiedColumns[MenuTableMap::COL_DEEP] = true;
        }
    ...
    public function setSectionId($v)
    {
        ...
        if ($this->section_id !== $v) {
            $this->section_id = $v;
            $this->modifiedColumns[MenuTableMap::COL_SECTION_ID] = true;
        }
    ...
    public function setBundleId($v)
    {
        ...
        if ($this->bundle_id !== $v) {
            $this->bundle_id = $v;
            $this->modifiedColumns[MenuTableMap::COL_BUNDLE_ID] = true;
        }
    ...
    public function setOrders($v)
    {
        ...
        if ($this->orders !== $v) {
            $this->orders = $v;
            $this->modifiedColumns[MenuTableMap::COL_ORDERS] = true;
        }
    ...
    public function setCanDelete($v)
    {
        ...
        if ($this->can_delete !== $v) {
            $this->can_delete = $v;
            $this->modifiedColumns[MenuTableMap::COL_CAN_DELETE] = true;
        }
    ...
    public function setLocked($v)
    {
        ...
        if ($this->locked !== $v) {
            $this->locked = $v;
            $this->modifiedColumns[MenuTableMap::COL_LOCKED] = true;
        }
    ...
    public function setPos($v)
    {
        ...
        if ($this->pos !== $v) {
            $this->pos = $v;
            $this->modifiedColumns[MenuTableMap::COL_POS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MenuTableMap::translateFieldName('Deep', TableMap::TYPE_PHPNAME, $indexType)];
            $this->deep = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MenuTableMap::translateFieldName('Parent', TableMap::TYPE_PHPNAME, $indexType)];
            $this->parent = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MenuTableMap::translateFieldName('SectionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->section_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MenuTableMap::translateFieldName('BundleId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bundle_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : MenuTableMap::translateFieldName('Orders', TableMap::TYPE_PHPNAME, $indexType)];
            $this->orders = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : MenuTableMap::translateFieldName('CanDelete', TableMap::TYPE_PHPNAME, $indexType)];
            $this->can_delete = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : MenuTableMap::translateFieldName('Locked', TableMap::TYPE_PHPNAME, $indexType)];
            $this->locked = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : MenuTableMap::translateFieldName('Pos', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pos = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : MenuTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : MenuTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 11; // 11 = MenuTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Common\\DbBundle\\Model\\Menu'), 0, $e);
        }
    }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(MenuTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(\Propel\Runtime\Util\PropelDateTime::createHighPrecision());
                }
            }
            if ($ret) {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->menuI18nsScheduledForDeletion !== null) {
                if (!$this->menuI18nsScheduledForDeletion->isEmpty()) {
                    \Common\DbBundle\Model\MenuI18nQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MenuTableMap::COL_DEEP)) {
            $modifiedColumns[':p' . $index++]  = '`deep`';
        }
        if ($this->isColumnModified(MenuTableMap::COL_PARENT)) {
            $modifiedColumns[':p' . $index++]  = '`parent`';
        }
        if ($this->isColumnModified(MenuTableMap::COL_SECTION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`section_id`';
        }
        if ($this->isColumnModified(MenuTableMap::COL_BUNDLE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`bundle_id`';
        }
        if ($this->isColumnModified(MenuTableMap::COL_ORDERS)) {
            $modifiedColumns[':p' . $index++]  = '`orders`';
        }
        if ($this->isColumnModified(MenuTableMap::COL_CAN_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '`can_delete`';
        }
        if ($this->isColumnModified(MenuTableMap::COL_LOCKED)) {
            $modifiedColumns[':p' . $index++]  = '`locked`';
        }
        if ($this->isColumnModified(MenuTableMap::COL_POS)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getSectionId(),
            $keys[4] => $this->getBundleId(),
            $keys[5] => $this->getOrders(),
            $keys[6] => $this->getCanDelete(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collMenuI18ns) {
                ...
                $result[$key] = $this->collMenuI18ns->toArray(null, false, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Common\DbBundle\Model\Menu
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setSectionId($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setBundleId($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setOrders($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setCanDelete($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setLocked($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setPos($arr[$keys[8]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Common\DbBundle\Model\Menu The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MenuTableMap::COL_DEEP)) {
            $criteria->add(MenuTableMap::COL_DEEP, $this->deep);
        }
        if ($this->isColumnModified(MenuTableMap::COL_PARENT)) {
            $criteria->add(MenuTableMap::COL_PARENT, $this->parent);
        }
        if ($this->isColumnModified(MenuTableMap::COL_SECTION_ID)) {
            $criteria->add(MenuTableMap::COL_SECTION_ID, $this->section_id);
        }
        if ($this->isColumnModified(MenuTableMap::COL_BUNDLE_ID)) {
            $criteria->add(MenuTableMap::COL_BUNDLE_ID, $this->bundle_id);
        }
        if ($this->isColumnModified(MenuTableMap::COL_ORDERS)) {
            $criteria->add(MenuTableMap::COL_ORDERS, $this->orders);
        }
        if ($this->isColumnModified(MenuTableMap::COL_CAN_DELETE)) {
            $criteria->add(MenuTableMap::COL_CAN_DELETE, $this->can_delete);
        }
        if ($this->isColumnModified(MenuTableMap::COL_LOCKED)) {
            $criteria->add(MenuTableMap::COL_LOCKED, $this->locked);
        }
        if ($this->isColumnModified(MenuTableMap::COL_POS)) {
            $criteria->add(MenuTableMap::COL_POS, $this->pos);
        }
        if ($this->isColumnModified(MenuTableMap::COL_CREATED_AT)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Common\DbBundle\Model\Menu (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Common\DbBundle\Model\Menu Clone of current object.
     * @throws PropelException
     */
    ...
    public function initMenuI18ns($overrideExisting = true)
    {
        ...
        $collectionClassName = MenuI18nTableMap::getTableMap()->getCollectionClassName();

        $this->collMenuI18ns = new $collectionClassName;
        $this->collMenuI18ns->setModel('\Common\DbBundle\Model\MenuI18n');
    }
     ...
     * @param      ConnectionInterface $con optional connection object
     * @return ObjectCollection|ChildMenuI18n[] List of ChildMenuI18n objects
     * @throws PropelException
     */
    public function getMenuI18ns(Criteria $criteria = null, ConnectionInterface $con = null)
    {
    ...
    /**
     * Sets a collection of ChildMenuI18n objects related by a one-to-many relationship
    ...
    {
        /** @var ChildMenuI18n[] $menuI18nsToDelete */
    ...
    public function addMenuI18n(ChildMenuI18n $l)
    {
        ...
        if (!$this->collMenuI18ns->contains($l)) {
            $this->doAddMenuI18n($l);

            if ($this->menuI18nsScheduledForDeletion and $this->menuI18nsScheduledForDeletion->contains($l)) {
                $this->menuI18nsScheduledForDeletion->remove($this->menuI18nsScheduledForDeletion->search($l));
            }
        }
    ...
    /**
     * @param ChildMenuI18n $menuI18n The ChildMenuI18n object to add.
     */
    protected function doAddMenuI18n(ChildMenuI18n $menuI18n)
    {
    ...
    /**
     * @param  ChildMenuI18n $menuI18n The ChildMenuI18n object to remove.
     * @return $this|ChildMenu The current object (for fluent API support)
     */
    public function removeMenuI18n(ChildMenuI18n $menuI18n)
    {
        if ($this->getMenuI18ns()->contains($menuI18n)) {
            $pos = $this->collMenuI18ns->search($menuI18n);
            $this->collMenuI18ns->remove($pos);
    ...
    {
        if (null !== $this->aSection) {
            $this->aSection->removeMenu($this);
        }
        if (null !== $this->aBundle) {
            $this->aBundle->removeMenu($this);
        }
        $this->id = null;
        $this->deep = null;
        $this->parent = null;
     ...
     *
     * @return string The value of the 'pos' column
     */
    public function __toString()
    {
        return (string) $this->getPos();
    }
    ...
    public function getCurrentTranslation(ConnectionInterface $con = null)
    {
         ...
         *
         * @param string $v new value
         * @return $this|\Common\DbBundle\Model\MenuI18n The current object (for fluent API support)
         */
