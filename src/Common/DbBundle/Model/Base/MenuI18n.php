...
abstract class MenuI18n implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Common\\DbBundle\\Model\\Map\\MenuI18nTableMap';
    ...
    /**
     * Initializes internal state of Common\DbBundle\Model\Base\MenuI18n object.
     * @see applyDefaults()
     */
     ...
     *
     * @return $this|MenuI18n The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MenuI18nTableMap::COL_ID] = true;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[MenuI18nTableMap::COL_LOCALE] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[MenuI18nTableMap::COL_TITLE] = true;
        }
    ...
    public function setStripTitle($v)
    {
        ...
        if ($this->strip_title !== $v) {
            $this->strip_title = $v;
            $this->modifiedColumns[MenuI18nTableMap::COL_STRIP_TITLE] = true;
        }
    ...
    public function setBrief($v)
    {
        ...
        if ($this->brief !== $v) {
            $this->brief = $v;
            $this->modifiedColumns[MenuI18nTableMap::COL_BRIEF] = true;
        }
    ...
    public function setContent($v)
    {
        ...
        if ($this->content !== $v) {
            $this->content = $v;
            $this->modifiedColumns[MenuI18nTableMap::COL_CONTENT] = true;
        }
    ...
    public function setLinkTo($v)
    {
        ...
        if ($this->link_to !== $v) {
            $this->link_to = $v;
            $this->modifiedColumns[MenuI18nTableMap::COL_LINK_TO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MenuI18nTableMap::translateFieldName('StripTitle', TableMap::TYPE_PHPNAME, $indexType)];
            $this->strip_title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MenuI18nTableMap::translateFieldName('Brief', TableMap::TYPE_PHPNAME, $indexType)];
            $this->brief = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : MenuI18nTableMap::translateFieldName('Content', TableMap::TYPE_PHPNAME, $indexType)];
            $this->content = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : MenuI18nTableMap::translateFieldName('LinkTo', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = MenuI18nTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Common\\DbBundle\\Model\\MenuI18n'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MenuI18nTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(MenuI18nTableMap::COL_LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(MenuI18nTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(MenuI18nTableMap::COL_STRIP_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`strip_title`';
        }
        if ($this->isColumnModified(MenuI18nTableMap::COL_BRIEF)) {
            $modifiedColumns[':p' . $index++]  = '`brief`';
        }
        if ($this->isColumnModified(MenuI18nTableMap::COL_CONTENT)) {
            $modifiedColumns[':p' . $index++]  = '`content`';
        }
        if ($this->isColumnModified(MenuI18nTableMap::COL_LINK_TO)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['MenuI18n'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MenuI18n'][$this->hashCode()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Common\DbBundle\Model\MenuI18n
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Common\DbBundle\Model\MenuI18n The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MenuI18nTableMap::COL_ID)) {
            $criteria->add(MenuI18nTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(MenuI18nTableMap::COL_LOCALE)) {
            $criteria->add(MenuI18nTableMap::COL_LOCALE, $this->locale);
        }
        if ($this->isColumnModified(MenuI18nTableMap::COL_TITLE)) {
            $criteria->add(MenuI18nTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(MenuI18nTableMap::COL_STRIP_TITLE)) {
            $criteria->add(MenuI18nTableMap::COL_STRIP_TITLE, $this->strip_title);
        }
        if ($this->isColumnModified(MenuI18nTableMap::COL_BRIEF)) {
            $criteria->add(MenuI18nTableMap::COL_BRIEF, $this->brief);
        }
        if ($this->isColumnModified(MenuI18nTableMap::COL_CONTENT)) {
            $criteria->add(MenuI18nTableMap::COL_CONTENT, $this->content);
        }
        if ($this->isColumnModified(MenuI18nTableMap::COL_LINK_TO)) {
            $criteria->add(MenuI18nTableMap::COL_LINK_TO, $this->link_to);
        }
    ...
    {
        $criteria = ChildMenuI18nQuery::create();
        $criteria->add(MenuI18nTableMap::COL_ID, $this->id);
        $criteria->add(MenuI18nTableMap::COL_LOCALE, $this->locale);
    ...
    public function hashCode()
    {
        ...
        //relation menu_i18n_fk_14b1c0 to table menu
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Common\DbBundle\Model\MenuI18n (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Common\DbBundle\Model\MenuI18n Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if (null !== $this->aMenu) {
            $this->aMenu->removeMenuI18n($this);
        }
        $this->id = null;
        $this->locale = null;
        $this->title = null;
