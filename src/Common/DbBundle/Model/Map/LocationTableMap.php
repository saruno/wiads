...
use Common\DbBundle\Model\Location;
...
class LocationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Common.DbBundle.Model.Map.LocationTableMap';
     ...
     */
    const OM_CLASS = '\\Common\\DbBundle\\Model\\Location';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Common.DbBundle.Model.Location';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(LocationTableMap::COL_ID, LocationTableMap::COL_NAME, LocationTableMap::COL_CODE, LocationTableMap::COL_CREATED_AT, LocationTableMap::COL_UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(LocationTableMap::COL_ID => 0, LocationTableMap::COL_NAME => 1, LocationTableMap::COL_CODE => 2, LocationTableMap::COL_CREATED_AT => 3, LocationTableMap::COL_UPDATED_AT => 4, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Common\\DbBundle\\Model\\Location');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LocationTableMap::COL_CODE);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Common\DbBundle\Model\Location) { // it's a model object
