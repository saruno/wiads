...
use Common\DbBundle\Model\LogsQuery;
...
class LogsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Common.DbBundle.Model.Map.LogsTableMap';
     ...
     */
    const OM_CLASS = '\\Common\\DbBundle\\Model\\Logs';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Common.DbBundle.Model.Logs';
     ...
     */
    const COL_EDIT_BY = 'logs.edit_by';

    /**
     * the column name for the table field
     */
    const COL_TABLE = 'logs.table';

    /**
     * the column name for the item_id field
     */
    const COL_ITEM_ID = 'logs.item_id';

    /**
     * the column name for the old field
     */
    const COL_OLD = 'logs.old';

    /**
     * the column name for the current field
     */
    const COL_CURRENT = 'logs.current';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'logs.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'logs.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'EditBy', 'Table', 'ItemId', 'Old', 'Current', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'editBy', 'table', 'itemId', 'old', 'current', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(LogsTableMap::COL_ID, LogsTableMap::COL_EDIT_BY, LogsTableMap::COL_TABLE, LogsTableMap::COL_ITEM_ID, LogsTableMap::COL_OLD, LogsTableMap::COL_CURRENT, LogsTableMap::COL_CREATED_AT, LogsTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'edit_by', 'table', 'item_id', 'old', 'current', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'EditBy' => 1, 'Table' => 2, 'ItemId' => 3, 'Old' => 4, 'Current' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'editBy' => 1, 'table' => 2, 'itemId' => 3, 'old' => 4, 'current' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(LogsTableMap::COL_ID => 0, LogsTableMap::COL_EDIT_BY => 1, LogsTableMap::COL_TABLE => 2, LogsTableMap::COL_ITEM_ID => 3, LogsTableMap::COL_OLD => 4, LogsTableMap::COL_CURRENT => 5, LogsTableMap::COL_CREATED_AT => 6, LogsTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'edit_by' => 1, 'table' => 2, 'item_id' => 3, 'old' => 4, 'current' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Common\\DbBundle\\Model\\Logs');
        $this->setPackage('src.Common.DbBundle.Model');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('edit_by', 'EditBy', 'VARCHAR', false, 1000, null);
        $this->addColumn('table', 'Table', 'VARCHAR', false, 1000, null);
        $this->addColumn('item_id', 'ItemId', 'INTEGER', false, null, null);
        $this->addColumn('old', 'Old', 'LONGVARCHAR', false, null, null);
        $this->addColumn('current', 'Current', 'LONGVARCHAR', false, null, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LogsTableMap::COL_EDIT_BY);
            $criteria->addSelectColumn(LogsTableMap::COL_TABLE);
            $criteria->addSelectColumn(LogsTableMap::COL_ITEM_ID);
            $criteria->addSelectColumn(LogsTableMap::COL_OLD);
            $criteria->addSelectColumn(LogsTableMap::COL_CURRENT);
            $criteria->addSelectColumn(LogsTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(LogsTableMap::COL_UPDATED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Common\DbBundle\Model\Logs) { // it's a model object
