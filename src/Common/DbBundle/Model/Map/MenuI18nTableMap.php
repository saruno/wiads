...
class MenuI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Common.DbBundle.Model.Map.MenuI18nTableMap';
     ...
     */
    const OM_CLASS = '\\Common\\DbBundle\\Model\\MenuI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Common.DbBundle.Model.MenuI18n';
     ...
     */
    const COL_ID = 'menu_i18n.id';

    /**
     * the column name for the locale field
     */
    const COL_LOCALE = 'menu_i18n.locale';

    /**
     * the column name for the title field
     */
    const COL_TITLE = 'menu_i18n.title';

    /**
     * the column name for the strip_title field
     */
    const COL_STRIP_TITLE = 'menu_i18n.strip_title';

    /**
     * the column name for the brief field
     */
    const COL_BRIEF = 'menu_i18n.brief';

    /**
     * the column name for the content field
     */
    const COL_CONTENT = 'menu_i18n.content';

    /**
     * the column name for the link_to field
     */
    const COL_LINK_TO = 'menu_i18n.link_to';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Locale', 'Title', 'StripTitle', 'Brief', 'Content', 'LinkTo', ),
        self::TYPE_CAMELNAME     => array('id', 'locale', 'title', 'stripTitle', 'brief', 'content', 'linkTo', ),
        self::TYPE_COLNAME       => array(MenuI18nTableMap::COL_ID, MenuI18nTableMap::COL_LOCALE, MenuI18nTableMap::COL_TITLE, MenuI18nTableMap::COL_STRIP_TITLE, MenuI18nTableMap::COL_BRIEF, MenuI18nTableMap::COL_CONTENT, MenuI18nTableMap::COL_LINK_TO, ),
        self::TYPE_FIELDNAME     => array('id', 'locale', 'title', 'strip_title', 'brief', 'content', 'link_to', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Locale' => 1, 'Title' => 2, 'StripTitle' => 3, 'Brief' => 4, 'Content' => 5, 'LinkTo' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'locale' => 1, 'title' => 2, 'stripTitle' => 3, 'brief' => 4, 'content' => 5, 'linkTo' => 6, ),
        self::TYPE_COLNAME       => array(MenuI18nTableMap::COL_ID => 0, MenuI18nTableMap::COL_LOCALE => 1, MenuI18nTableMap::COL_TITLE => 2, MenuI18nTableMap::COL_STRIP_TITLE => 3, MenuI18nTableMap::COL_BRIEF => 4, MenuI18nTableMap::COL_CONTENT => 5, MenuI18nTableMap::COL_LINK_TO => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'locale' => 1, 'title' => 2, 'strip_title' => 3, 'brief' => 4, 'content' => 5, 'link_to' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Common\\DbBundle\\Model\\MenuI18n');
        ...
        $this->getColumn('link_to')->setPrimaryString(true);
    } // initialize()
    ...
    {
        $this->addRelation('Menu', '\\Common\\DbBundle\\Model\\Menu', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':id',
    1 => ':id',
     ...
     * and findPk*() calls.
     *
     * @param \Common\DbBundle\Model\MenuI18n $obj A \Common\DbBundle\Model\MenuI18n object.
     ...
     *
     * @param mixed $value A \Common\DbBundle\Model\MenuI18n object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Common\DbBundle\Model\MenuI18n) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Common\DbBundle\Model\MenuI18n object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(MenuI18nTableMap::COL_ID);
            $criteria->addSelectColumn(MenuI18nTableMap::COL_LOCALE);
            $criteria->addSelectColumn(MenuI18nTableMap::COL_TITLE);
            $criteria->addSelectColumn(MenuI18nTableMap::COL_STRIP_TITLE);
            $criteria->addSelectColumn(MenuI18nTableMap::COL_BRIEF);
            $criteria->addSelectColumn(MenuI18nTableMap::COL_CONTENT);
            $criteria->addSelectColumn(MenuI18nTableMap::COL_LINK_TO);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Common\DbBundle\Model\MenuI18n) { // it's a model object
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(MenuI18nTableMap::COL_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(MenuI18nTableMap::COL_LOCALE, $value[1]));
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ((array) $values as $singleval) {
                MenuI18nTableMap::removeInstanceFromPool($singleval);
            }
        }
