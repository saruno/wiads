...
use AdvertiserBundle\Model\Map\DepartmentTableMap;
 ...
 * @method     ChildDepartmentQuery orderByCode($order = Criteria::ASC) Order by the code column
 ...
 * @method     ChildDepartmentQuery groupByCode() Group by the code column
 ...
 *
 * @method     \AdvertiserBundle\Model\EmployeeQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildDepartment findOneByCode(string $code) Return the first ChildDepartment filtered by the code column
 * @method     ChildDepartment findOneByCreatedAt(string $created_at) Return the first ChildDepartment filtered by the created_at column
 * @method     ChildDepartment findOneByUpdatedAt(string $updated_at) Return the first ChildDepartment filtered by the updated_at column *
 ...
 * @method     ChildDepartment requireOneByCode(string $code) Return the first ChildDepartment filtered by the code column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildDepartment[]|ObjectCollection findByCode(string $code) Return ChildDepartment objects filtered by the code column
...
abstract class DepartmentQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \AdvertiserBundle\Model\Base\DepartmentQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\AdvertiserBundle\\Model\\Department', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name`, `code`, `created_at`, `updated_at` FROM `department` WHERE `id` = :p0';
        try {
    ...
    public function filterByCode($code = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(DepartmentTableMap::COL_CODE, $code, $comparison);
    }
     ...
     *
     * @param \AdvertiserBundle\Model\Employee|ObjectCollection $employee the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
