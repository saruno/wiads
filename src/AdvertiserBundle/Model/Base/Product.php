...
abstract class Product implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\AdvertiserBundle\\Model\\Map\\ProductTableMap';
    ...
    /**
     * @var        ChildCategoryProduct
     */
    protected $aCategoryProduct;
    ...
    /**
     * Initializes internal state of AdvertiserBundle\Model\Base\Product object.
     */
     ...
     * @return $this|\AdvertiserBundle\Model\Product The current object (for fluent API support)
     */
    ...
    public function setCategoryId($v)
    {
        ...
        if ($this->aCategoryProduct !== null && $this->aCategoryProduct->getId() !== $v) {
            $this->aCategoryProduct = null;
        }
    ...
    public function setWarehouseId($v)
    {
        ...
        if ($this->warehouse_id !== $v) {
            $this->warehouse_id = $v;
            $this->modifiedColumns[ProductTableMap::COL_WAREHOUSE_ID] = true;
        }
    ...
    /**
     * Set the value of [slton] column.
     *
     * @param int $v new value
     * @return $this|\AdvertiserBundle\Model\Product The current object (for fluent API support)
     */
    public function setSlton($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->slton !== $v) {
            $this->slton = $v;
            $this->modifiedColumns[ProductTableMap::COL_SLTON] = true;
        }
    ...
    /**
     * Set the value of [donvi] column.
     *
     * @param string $v new value
     * @return $this|\AdvertiserBundle\Model\Product The current object (for fluent API support)
     */
    public function setDonvi($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->donvi !== $v) {
            $this->donvi = $v;
            $this->modifiedColumns[ProductTableMap::COL_DONVI] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProductTableMap::translateFieldName('CategoryId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->category_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProductTableMap::translateFieldName('WarehouseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warehouse_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProductTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ProductTableMap::translateFieldName('Slton', TableMap::TYPE_PHPNAME, $indexType)];
            $this->slton = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ProductTableMap::translateFieldName('Donvi', TableMap::TYPE_PHPNAME, $indexType)];
            $this->donvi = (null !== $col) ? (string) $col : null;
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\AdvertiserBundle\\Model\\Product'), 0, $e);
        }
    }
    ...
    {
        if ($this->aCategoryProduct !== null && $this->category_id !== $this->aCategoryProduct->getId()) {
            $this->aCategoryProduct = null;
        }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aCategoryProduct !== null) {
                if ($this->aCategoryProduct->isModified() || $this->aCategoryProduct->isNew()) {
                    $affectedRows += $this->aCategoryProduct->save($con);
                }
                $this->setCategoryProduct($this->aCategoryProduct);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProductTableMap::COL_WAREHOUSE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`warehouse_id`';
        }
        if ($this->isColumnModified(ProductTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ProductTableMap::COL_SLTON)) {
            $modifiedColumns[':p' . $index++]  = '`slton`';
        }
        if ($this->isColumnModified(ProductTableMap::COL_DONVI)) {
            $modifiedColumns[':p' . $index++]  = '`donvi`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`name`':
                        ...
                        break;
                    case '`slton`':
                        $stmt->bindValue($identifier, $this->slton, PDO::PARAM_INT);
                        break;
                    case '`donvi`':
                        $stmt->bindValue($identifier, $this->donvi, PDO::PARAM_STR);
                        break;
                    case '`description`':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 3:
                ...
                break;
            case 4:
                return $this->getSlton();
                break;
            case 5:
                return $this->getDonvi();
                break;
            case 6:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getName(),
            $keys[4] => $this->getSlton(),
            $keys[5] => $this->getDonvi(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aCategoryProduct) {
                ...
                $result[$key] = $this->aCategoryProduct->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AdvertiserBundle\Model\Product
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setSlton($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setDonvi($arr[$keys[5]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AdvertiserBundle\Model\Product The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductTableMap::COL_WAREHOUSE_ID)) {
            $criteria->add(ProductTableMap::COL_WAREHOUSE_ID, $this->warehouse_id);
        }
        if ($this->isColumnModified(ProductTableMap::COL_NAME)) {
            $criteria->add(ProductTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ProductTableMap::COL_SLTON)) {
            $criteria->add(ProductTableMap::COL_SLTON, $this->slton);
        }
        if ($this->isColumnModified(ProductTableMap::COL_DONVI)) {
            $criteria->add(ProductTableMap::COL_DONVI, $this->donvi);
        }
        if ($this->isColumnModified(ProductTableMap::COL_DESCRIPTION)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AdvertiserBundle\Model\Product (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setSlton($this->getSlton());
        $copyObj->setDonvi($this->getDonvi());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AdvertiserBundle\Model\Product Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildCategoryProduct object.
     *
     * @param  ChildCategoryProduct $v
     * @return $this|\AdvertiserBundle\Model\Product The current object (for fluent API support)
     * @throws PropelException
     */
    public function setCategoryProduct(ChildCategoryProduct $v = null)
    {
        if ($v === null) {
        ...
        $this->aCategoryProduct = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildCategoryProduct object, it will not be re-added.
        if ($v !== null) {
            $v->addProduct($this);
        }
    ...
    /**
     * Get the associated ChildCategoryProduct object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildCategoryProduct The associated ChildCategoryProduct object.
     * @throws PropelException
     */
    public function getCategoryProduct(ConnectionInterface $con = null)
    {
        if ($this->aCategoryProduct === null && ($this->category_id !== null)) {
            $this->aCategoryProduct = ChildCategoryProductQuery::create()->findPk($this->category_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCategoryProduct->addProducts($this);
             */
        }

        return $this->aCategoryProduct;
    }
    ...
    public function getWarehouse(ConnectionInterface $con = null)
    {
        if ($this->aWarehouse === null && ($this->warehouse_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aWarehouse->addProducts($this);
             */
        }
    ...
    public function setInventoryReceivingVoucherDetails(Collection $inventoryReceivingVoucherDetails, ConnectionInterface $con = null)
    {
        ...
        foreach ($inventoryReceivingVoucherDetailsToDelete as $inventoryReceivingVoucherDetailRemoved) {
            $inventoryReceivingVoucherDetailRemoved->setProduct(null);
        }
    ...
    protected function doAddInventoryReceivingVoucherDetail(ChildInventoryReceivingVoucherDetail $inventoryReceivingVoucherDetail)
    {
        ...
        $inventoryReceivingVoucherDetail->setProduct($this);
    }
    ...
    public function removeInventoryReceivingVoucherDetail(ChildInventoryReceivingVoucherDetail $inventoryReceivingVoucherDetail)
    {
        if ($this->getInventoryReceivingVoucherDetails()->contains($inventoryReceivingVoucherDetail)) {
            ...
            $inventoryReceivingVoucherDetail->setProduct(null);
        }
     ...
     * @return ObjectCollection|ChildInventoryReceivingVoucherDetail[] List of ChildInventoryReceivingVoucherDetail objects
     */
    public function getInventoryReceivingVoucherDetailsJoinInventoryReceivingVoucher(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildInventoryReceivingVoucherDetailQuery::create(null, $criteria);
        $query->joinWith('InventoryReceivingVoucher', $joinBehavior);
    ...
    public function setInventoryDeliveryVoucherDetails(Collection $inventoryDeliveryVoucherDetails, ConnectionInterface $con = null)
    {
        ...
        foreach ($inventoryDeliveryVoucherDetailsToDelete as $inventoryDeliveryVoucherDetailRemoved) {
            $inventoryDeliveryVoucherDetailRemoved->setProduct(null);
        }
    ...
    protected function doAddInventoryDeliveryVoucherDetail(ChildInventoryDeliveryVoucherDetail $inventoryDeliveryVoucherDetail)
    {
        ...
        $inventoryDeliveryVoucherDetail->setProduct($this);
    }
    ...
    public function removeInventoryDeliveryVoucherDetail(ChildInventoryDeliveryVoucherDetail $inventoryDeliveryVoucherDetail)
    {
        if ($this->getInventoryDeliveryVoucherDetails()->contains($inventoryDeliveryVoucherDetail)) {
            ...
            $inventoryDeliveryVoucherDetail->setProduct(null);
        }
     ...
     * @return ObjectCollection|ChildInventoryDeliveryVoucherDetail[] List of ChildInventoryDeliveryVoucherDetail objects
     */
    public function getInventoryDeliveryVoucherDetailsJoinInventoryDeliveryVoucher(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildInventoryDeliveryVoucherDetailQuery::create(null, $criteria);
        $query->joinWith('InventoryDeliveryVoucher', $joinBehavior);
    ...
    {
        if (null !== $this->aCategoryProduct) {
            $this->aCategoryProduct->removeProduct($this);
        }
        if (null !== $this->aWarehouse) {
            $this->aWarehouse->removeProduct($this);
        }
        $this->id = null;
