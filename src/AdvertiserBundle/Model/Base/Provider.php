...
abstract class Provider implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\AdvertiserBundle\\Model\\Map\\ProviderTableMap';
    ...
    /**
     * Initializes internal state of AdvertiserBundle\Model\Base\Provider object.
     */
     ...
     * @return $this|\AdvertiserBundle\Model\Provider The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ProviderTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ProviderTableMap::COL_NAME] = true;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[ProviderTableMap::COL_ADDRESS] = true;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[ProviderTableMap::COL_PHONE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProviderTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProviderTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProviderTableMap::translateFieldName('Address', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProviderTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ProviderTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ProviderTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = ProviderTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\AdvertiserBundle\\Model\\Provider'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProviderTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ProviderTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ProviderTableMap::COL_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = '`address`';
        }
        if ($this->isColumnModified(ProviderTableMap::COL_PHONE)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AdvertiserBundle\Model\Provider
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AdvertiserBundle\Model\Provider The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProviderTableMap::COL_ID)) {
            $criteria->add(ProviderTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ProviderTableMap::COL_NAME)) {
            $criteria->add(ProviderTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ProviderTableMap::COL_ADDRESS)) {
            $criteria->add(ProviderTableMap::COL_ADDRESS, $this->address);
        }
        if ($this->isColumnModified(ProviderTableMap::COL_PHONE)) {
            $criteria->add(ProviderTableMap::COL_PHONE, $this->phone);
        }
        if ($this->isColumnModified(ProviderTableMap::COL_CREATED_AT)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AdvertiserBundle\Model\Provider (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AdvertiserBundle\Model\Provider Clone of current object.
     * @throws PropelException
     */
    ...
    public function setInventoryReceivingVouchers(Collection $inventoryReceivingVouchers, ConnectionInterface $con = null)
    {
        ...
        foreach ($inventoryReceivingVouchersToDelete as $inventoryReceivingVoucherRemoved) {
            $inventoryReceivingVoucherRemoved->setProvider(null);
        }
    ...
    protected function doAddInventoryReceivingVoucher(ChildInventoryReceivingVoucher $inventoryReceivingVoucher)
    {
        ...
        $inventoryReceivingVoucher->setProvider($this);
    }
    ...
    public function removeInventoryReceivingVoucher(ChildInventoryReceivingVoucher $inventoryReceivingVoucher)
    {
        if ($this->getInventoryReceivingVouchers()->contains($inventoryReceivingVoucher)) {
            ...
            $inventoryReceivingVoucher->setProvider(null);
        }
     ...
     * @return ObjectCollection|ChildInventoryReceivingVoucher[] List of ChildInventoryReceivingVoucher objects
     */
    public function getInventoryReceivingVouchersJoinWarehouse(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildInventoryReceivingVoucherQuery::create(null, $criteria);
