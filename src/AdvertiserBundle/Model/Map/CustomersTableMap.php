...
use AdvertiserBundle\Model\Customers;
use AdvertiserBundle\Model\CustomersQuery;
...
class CustomersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.AdvertiserBundle.Model.Map.CustomersTableMap';
     ...
     */
    const OM_CLASS = '\\AdvertiserBundle\\Model\\Customers';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.AdvertiserBundle.Model.Customers';
     ...
     */
    const COL_ADDRESS = 'customers.address';
     ...
     */
    const COL_CREATED_AT = 'customers.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'customers.updated_at';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(CustomersTableMap::COL_ID, CustomersTableMap::COL_NAME, CustomersTableMap::COL_ADDRESS, CustomersTableMap::COL_PHONE, CustomersTableMap::COL_CREATED_AT, CustomersTableMap::COL_UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(CustomersTableMap::COL_ID => 0, CustomersTableMap::COL_NAME => 1, CustomersTableMap::COL_ADDRESS => 2, CustomersTableMap::COL_PHONE => 3, CustomersTableMap::COL_CREATED_AT => 4, CustomersTableMap::COL_UPDATED_AT => 5, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AdvertiserBundle\\Model\\Customers');
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to customers     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CustomersTableMap::COL_ADDRESS);
            $criteria->addSelectColumn(CustomersTableMap::COL_PHONE);
            $criteria->addSelectColumn(CustomersTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(CustomersTableMap::COL_UPDATED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AdvertiserBundle\Model\Customers) { // it's a model object
