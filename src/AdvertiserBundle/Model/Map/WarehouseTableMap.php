...
use AdvertiserBundle\Model\Warehouse;
use AdvertiserBundle\Model\WarehouseQuery;
...
/**
 * This class defines the structure of the 'warehouse' table.
 *
 *
 *
...
class WarehouseTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.AdvertiserBundle.Model.Map.WarehouseTableMap';
     ...
     */
    const OM_CLASS = '\\AdvertiserBundle\\Model\\Warehouse';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.AdvertiserBundle.Model.Warehouse';
     ...
     */
    const COL_ID = 'warehouse.id';

    /**
     * the column name for the employee_id field
     */
    const COL_EMPLOYEE_ID = 'warehouse.employee_id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'warehouse.name';

    /**
     * the column name for the address field
     */
    const COL_ADDRESS = 'warehouse.address';

    /**
     * the column name for the phone field
     */
    const COL_PHONE = 'warehouse.phone';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'warehouse.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'warehouse.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'EmployeeId', 'Name', 'Address', 'Phone', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'employeeId', 'name', 'address', 'phone', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(WarehouseTableMap::COL_ID, WarehouseTableMap::COL_EMPLOYEE_ID, WarehouseTableMap::COL_NAME, WarehouseTableMap::COL_ADDRESS, WarehouseTableMap::COL_PHONE, WarehouseTableMap::COL_CREATED_AT, WarehouseTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'employee_id', 'name', 'address', 'phone', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'EmployeeId' => 1, 'Name' => 2, 'Address' => 3, 'Phone' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'employeeId' => 1, 'name' => 2, 'address' => 3, 'phone' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(WarehouseTableMap::COL_ID => 0, WarehouseTableMap::COL_EMPLOYEE_ID => 1, WarehouseTableMap::COL_NAME => 2, WarehouseTableMap::COL_ADDRESS => 3, WarehouseTableMap::COL_PHONE => 4, WarehouseTableMap::COL_CREATED_AT => 5, WarehouseTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'employee_id' => 1, 'name' => 2, 'address' => 3, 'phone' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AdvertiserBundle\\Model\\Warehouse');
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('InventoryReceivingVoucher', '\\AdvertiserBundle\\Model\\InventoryReceivingVoucher', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':warehouse_id',
    1 => ':id',
  ),
), 'SET NULL', 'CASCADE', 'InventoryReceivingVouchers', false);
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to warehouse     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(WarehouseTableMap::COL_EMPLOYEE_ID);
            $criteria->addSelectColumn(WarehouseTableMap::COL_NAME);
            $criteria->addSelectColumn(WarehouseTableMap::COL_ADDRESS);
            $criteria->addSelectColumn(WarehouseTableMap::COL_PHONE);
            $criteria->addSelectColumn(WarehouseTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(WarehouseTableMap::COL_UPDATED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AdvertiserBundle\Model\Warehouse) { // it's a model object
