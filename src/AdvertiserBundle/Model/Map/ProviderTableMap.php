...
use AdvertiserBundle\Model\Provider;
use AdvertiserBundle\Model\ProviderQuery;
...
class ProviderTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.AdvertiserBundle.Model.Map.ProviderTableMap';
     ...
     */
    const OM_CLASS = '\\AdvertiserBundle\\Model\\Provider';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.AdvertiserBundle.Model.Provider';
     ...
     */
    const COL_ID = 'provider.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'provider.name';

    /**
     * the column name for the address field
     */
    const COL_ADDRESS = 'provider.address';

    /**
     * the column name for the phone field
     */
    const COL_PHONE = 'provider.phone';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Address', 'Phone', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'address', 'phone', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(ProviderTableMap::COL_ID, ProviderTableMap::COL_NAME, ProviderTableMap::COL_ADDRESS, ProviderTableMap::COL_PHONE, ProviderTableMap::COL_CREATED_AT, ProviderTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'address', 'phone', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Address' => 2, 'Phone' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'address' => 2, 'phone' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(ProviderTableMap::COL_ID => 0, ProviderTableMap::COL_NAME => 1, ProviderTableMap::COL_ADDRESS => 2, ProviderTableMap::COL_PHONE => 3, ProviderTableMap::COL_CREATED_AT => 4, ProviderTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'address' => 2, 'phone' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AdvertiserBundle\\Model\\Provider');
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to provider     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProviderTableMap::COL_ADDRESS);
            $criteria->addSelectColumn(ProviderTableMap::COL_PHONE);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AdvertiserBundle\Model\Provider) { // it's a model object
