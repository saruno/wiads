...
{	
	...
	{	
    	...
    	$conn_total 		= "n/a";//$this->getTotalConnect($time_);
    	...
    	$conn_android 				= "n/a";//$this->getTotalConnect($time_, array('os' => 'Android'));
    	$conn_iphone 				= "n/a";//$this->getTotalConnect($time_, array('os' => 'iPhone'));
    	$conn_windows 				= "n/a";//$this->getTotalConnect($time_, array('os' => 'Windows'));
    	$conn_windows_phone 		= "n/a";//$this->getTotalConnect($time_, array('os' => 'Windows Phone'));
    	$conn_ipad 					= "n/a";//$this->getTotalConnect($time_, array('os' => 'iPad'));
    	$conn_macintosh 			= "n/a";//$this->getTotalConnect($time_, array('os' => 'Macintosh'));
    	$conn_blackBerry 			= "n/a";//$this->getTotalConnect($time_, array('os' => 'BlackBerry'));
    	...
    	$conn_browser_chrome 		= "n/a";//$this->getTotalConnect($time_, array('browser' => 'Chrome'));
    	$conn_browser_firefox 		= "n/a";//$this->getTotalConnect($time_, array('browser' => 'Firefox'));
    	$conn_browser_appleWebKit 	= "n/a";//$this->getTotalConnect($time_, array('browser' => 'AppleWebKit'));
    	$conn_browser_safari 		= "n/a";//$this->getTotalConnect($time_, array('browser' => 'Safari'));
    	$conn_browser_opera 		= "n/a";//$this->getTotalConnect($time_, array('browser' => 'Opera Next'));
    	$conn_browser_ieMobile 		= "n/a";//$this->getTotalConnect($time_, array('browser' => 'IEMobile'));
    	$conn_browser_uc 			= "n/a";//$this->getTotalConnect($time_, array('browser' => 'UC Browser'));
