...
class APConnectControllerXXX extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        //return $this->render('HotspotAccessPointBundle:APConnect:5.html.twig',array('responses'=>null,'params' =>$params));
        /**
         * LOGING IN
         */
        if ($button == 'Login' || $button == 'Free Internet') {
            ...
            if ($result == 5) {
                ...
                //$params['userurl']="195"."___".$challenge."___".$userurl;
                /** @var Advert $adv */
        ...
        if ($result == 1 || $result == 4 || $result == 12) {
            ...
            if($advertId==-1 && !empty($ads)){
                ...
                /*
                if($os=='Android') {
                    $linkTo = AdvertHelper::getAdsmeeLink($params, $api_service);
                }
                */
                if(empty($linkTo))
                    $linkTo=AdvertHelper::getAdvLink($ads[0]->getId(), $params);
            ...
            if(!empty($linkTo) && $advertId!=-2)
                ...
                if(!empty($adv) && $adv->getHomePosition()=='QAF_v4') {
                    ...
                    //return $this->render('HotspotAccessPointBundle:APConnect:success_v4.html.twig', array('responses' => $responses, 'params' => $params, 'adv' => $adv, 'linkTo' => $linkTo));
                    return $this->render($template, array('responses' => $responses, 'params' => $params, 'adv' => $adv, 'linkTo' => $linkTo));
                }
        ...
        /*
        if ($result == 1) {
            return $this->render('HotspotAccessPointBundle:APConnect:1.html.twig',$params);
        }
        */
        if ($result == 2) {
            $adsCookie=$sessionid.rand();
        ...
        if (($result == 4) || ($result == 12)) {
            ...
            $ads=AdvertHelper::getAds($params);
             ...
             //var_dump($params);
             //return $this->render('HotspotAccessPointBundle:APConnect:4.html.twig',$params);
             return $this->render('HotspotAccessPointBundle:APConnect:act.html.twig',array('responses'=>$responses,'params' =>$params,'ads'=>$ads));
        }
        */
        if ($result == 5) {
            ...
            */
            ...
            if($params['called']=='F4-F2-6D-FD-27-8D' || $params['called']=='EC-08-6B-89-DD-AF'){
                return $this->render('HotspotAccessPointBundle:APConnect:F4_F2_6D_FD_27_8D.html.twig',array('responses'=>$responses,'params' =>$params));
            }
            else
            */
            ...
            //if($params['called']=='EC-08-6B-89-DD-B0'){
            if( empty($template)
                || (!$is_privated && $template == 'HotspotAccessPointBundle:APConnect:captival_full_screen_v4.html.twig')
                || (!$is_privated && $template == 'HotspotAccessPointBundle:APConnect:captival_v4.html.twig')
            ){
                if(!empty($adv)){
    ...
    public function reportAction(Request $request){
        ...
        $templates = array('captival_full_screen_v4.html.twig'=>'Tự động login - Quảng cáo chung - 640x710',
