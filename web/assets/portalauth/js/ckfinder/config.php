...
function CheckAuthentication()
{
	...
	// ... where $_COOKIE['IsAuthorized'] is set to "true" as soon as the
	// user logs in your system. To be able to use session variables don't
	// forget to add session_start() at the top of this file.
	//$session = unserialize($_COOKIE['ci_session']);
	//return true;
	return isset($_COOKIE['MEDIA_POST']) && $_COOKIE['MEDIA_POST'];
}
...
$_SESSION['CKFinder_UserRole'] = $_COOKIE['USER_NAME'];
//session_start();
...
$config['AccessControl'][] = Array(
		'role' =>$_COOKIE['USER_NAME'],
		'resourceType' => '*',
		'folder' => "/".$_COOKIE['USER_NAME'],
...
$config['ResourceType'][] = Array(
		'name' => 'UserFiles',
		'url' => $baseUrl . $_COOKIE['USER_NAME'].'/files',
		'directory' => $baseDir . $_COOKIE['USER_NAME'].'/files',
		'maxSize' => 0,
		'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
		'deniedExtensions' => '');
$config['ResourceType'][] = Array(
		'name' => 'UserImages',
		'url' => $baseUrl . $_COOKIE['USER_NAME'].'/images',
		'directory' => $baseDir . $_COOKIE['USER_NAME'].'/images',
		'maxSize' => 0,
		'maxSize' => 0,
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
		'deniedExtensions' => '');
$config['ResourceType'][] = Array(
		'name' => 'UserVideo',
		'url' => $baseUrl . $_COOKIE['USER_NAME'].'/video',
		'directory' => $baseDir . $_COOKIE['USER_NAME'].'/video',
		'maxSize' => 0,
		'allowedExtensions' => 'swf,flv',
		'deniedExtensions' => '');
*/
...
/*
$config['ResourceType'][] = Array(
		'name' => 'Others',				// Single quotes not allowed
		'url' => $baseUrl,
		'directory' => $baseDir,
		'maxSize' => 0,
		'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
...
$config['plugin_imageresize']['smallThumb'] = '140x93';
$config['plugin_imageresize']['mediumThumb'] = '300x200';
$config['plugin_imageresize']['largeThumb'] = '460x307';